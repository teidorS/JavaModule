...
def is_blackjack(card_one, card_two):
    ...
    has_ace = ACE in (card_one, card_two)

    return is_21 and has_ace
...
def can_split_pairs(card_one, card_two):
    ...
    return value_of_card_one == value_of_card_two and card_one == card_two
...
def can_double_down(card_one, card_two):
    ...
    return value_of_card(card_one) + value_of_card(card_two) in double_down_rate
